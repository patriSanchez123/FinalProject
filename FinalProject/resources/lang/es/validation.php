...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex' => 'El campo de  contraseña tiene que tener al menos una letra mayuscula, una minuscula, un numero, y un caracter especial(#?!@$%^&*-_) y al menos 8 caracteres',
        ],
        'dni'=>[
            'regex'=> 'Introduce un dni válido, 8 numeros seguido de una letra'],
        'name'=>[
            'required'=>'El campo nombre es obligatorio',
            'min'=>'El campo nombre debe ser al menos :min.',
            'max'=> 'El campo nombre no debe ser mayor a :max.'
        ],
        'phone'=>[
            'regex'=>'Introduce un télefono válido',
            'required'=>'El campo télefono es obligatorio'
        ],
        'ss'=>[
            'required'=>'El campo télefono es obligatorio',
            'regex'=>'Introduce un numero de seguridad social válido, debe de contener 12 dígitos'
        ]
    ],
